...
export default function PriceCard({
  ...
  return (
    <Card 
    classNmae={header ? 'package__card active' : 'package__card'}
    sx={styles.pricingBox}
     >
      {header && <Text sx={styles.header} >{header}</Text>} 
      <Box>
        <Box classNmae='package__header' sx={styles.pricingHeader}>
          <Heading classNmae='package__name' variant='title' >
            {name}
           </Heading>
